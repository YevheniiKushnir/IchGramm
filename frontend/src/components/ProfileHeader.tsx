  ...
  return (
    <>
      <div className="flex gap-4 px-6 md:gap-12 lg:gap-20">
        <img
          className="rounded-[50%] border border-gray w-28 h-28 object-cover md:min-w-[150px] md:h-[150px]"
        ...
        <div>
          <div className="flex flex-col items-start md:flex-row md:items-center gap-2 mb-3">
            ...
            {!ifUser ? (
              <div className="flex gap-2 mb-4">
                {!isFollowing && (
                  <Button color="blue" onClick={onFollow}>
                    Follow
                  </Button>
                )}
                {isFollowing && (
                  <Button color="gray" onClick={onUnfollow}>
                    {" "}
                    Unfollow
                  </Button>
                )}
          ...
          {user.website && (
            <div className="hidden md:flex gap-1 text-darkblue text-sm mt-4">
              <img src={webLink} alt="Website" />
              <a
                href={
      ...
      <div className="md:hidden pl-6 text-sm w-[90vw] break-words">
        ...
        {user?.website && (
          <div className="flex gap-1 text-darkblue text-sm mt-4">
            <img src={webLink} alt="Website" />
            <p>{user?.website}</p>
          </div>
        )}
